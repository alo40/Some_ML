...
def project_onto_PC(X, pcs, n_components, feature_means):
    ...
    """
    # DONE: first center data using the feature_means
    # DONE: Return the projection of the centered dataset
    ...
    # Not used: eigenvalues, eigenvectors = np.linalg.eig(np.transpose(X_center) @ X)
    #           V = eigenvectors
